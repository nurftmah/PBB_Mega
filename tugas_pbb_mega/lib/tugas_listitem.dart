...
class ImageItem implements ListItem{
  ...
  Widget buildSubtitle(BuildContext context){
    ...
    child: Image.asset(imagePath,height: 50, width: double.infinity, fit: BoxFit.cover,
    ),
    );
  }
}

class TugasListitem extends StatelessWidget {
  const TugasListitem({super.key});
    ...
    final List<ListItem> items = List<ListItem>.generate(
      ...
      (i) {
        if (i % 5 == 0){
          ...
          return ImageItem('images/kamari.jpg', 'Image Item $i');
        } else {
